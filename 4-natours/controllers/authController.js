...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  if (!currentUser) {
    return next(
      new AppError(
        'The user belongeng to this token does no longer exist.',
        401,
      ),
    );
  }
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  const message = `Forgot your password? Submit a PACH requiest with your new password and passwordConfirm to: ${resetURL}.\nIf you didn't forgot your password, Please ignore this email!`;
  try {
    await sendEmail({
      email: user.email,
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  // 2) vheck if posted current password is correct
