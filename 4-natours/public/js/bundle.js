  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    locations.forEach(function (loc) {
      var _loc$coordinates = _slicedToArray(loc.coordinates, 2),
        ...
        lat = _loc$coordinates[1]; // Extract longitude and latitude
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updatSettings.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Data update successfully!');
          }
          _context.next = 10;
          break;
        case 7:
...
var _updatSettings = require("./updatSettings");
/* eslint-disable */
